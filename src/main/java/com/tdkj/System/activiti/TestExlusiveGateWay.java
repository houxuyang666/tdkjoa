 ...
 */
@Slf4j
public class TestExlusiveGateWay {
    ...
    public void deployProcess(){
        ...
        Deployment deploy=repositoryService.createDeployment().name("报销费用流程") //流程设置一个名字
    ...
    public void startProcess(){
        ...
        ProcessInstance leavebill = runtimeService.startProcessInstanceByKey("ExclusiveGateWay");// act_re_procdef表中的KEY
