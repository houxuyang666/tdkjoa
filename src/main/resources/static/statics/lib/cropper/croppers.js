...
layui.config({
    ...
    var $ = layui.jquery
        ,layer = layui.layer;
    var html = "<link rel=\"stylesheet\" href=\"/statics/lib/cropper/cropper.css\">\n" +
        ...
        "            <div class=\"img-preview\" style=\"width:200px;height:200px;overflow:hidden;border-radius: 50%\">\n" +
        "            </div>\n" +
        "        </div>\n" +
        "    </div>\n" +
        "    <div class=\"layui-row layui-col-space15\">\n" +
        ...
        "                    <button type=\"button\" class=\"layui-btn\" title=\"移动\">移动</button>\n" +
        "                    <button type=\"button\" class=\"layui-btn\" title=\"放大图片\">放大图片</button>\n" +
        "                    <button type=\"button\" class=\"layui-btn\" title=\"缩小图片\">缩小图片</button>\n" +
            ...
            $(elem).on('click',function () {
                layer.open({
                    ...
                    , success: function () {
                        ...
                        image.cropper('destroy').attr('src', pathimage).cropper(options);
                    }
