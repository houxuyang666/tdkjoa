...
public class TestSequenceFlow {
    ...
    public void deployProcess(){
        ...
        Deployment deploy=repositoryService.createDeployment().name("报销流程") //流程设置一个名字
                .addClasspathResource("processes/SequenceFlow.bpmn").deploy();
    ...
    public void startProcess(){
        ...
        ProcessInstance leavebill = runtimeService.startProcessInstanceByKey("SequenceFlow");// act_re_procdef表中的KEY
